...
export default function Page() {
  return (
    <section className="rounded-lg border border-white/10 bg-black/40 p-5">
      ...
      <h1 className="mt-2 text-3xl font-black tracking-tight">Client Portal</h1>
      <p className="mt-3 max-w-3xl text-sm leading-relaxed text-muted-whites/65">
        Current portal destination is configured for MyCase. This page can later
        hold connection status, SSO notes, and portal support requests.
      </p>
      <a
